...
import ${package}.error_handling.helpers.UniqueViolationExceptionThrower;
import ${package}.exceptions.NoSuchEntityException;
import ${package}.exceptions.UnauthorizedException;
import ${package}.models.Role;
import ${package}.models.User;
import ${package}.persistence.daos.UserDao;
import ${package}.persistence.query_helpers.UserQueryHelper;
import ${package}.security.PasswordValidator;
...
public class UserServiceImpl implements UserService, UniqueViolationExceptionThrower {
    ...
    @Override
    @PreAuthorize("@userPermissionProvider.readById(${symbol_pound}id)")
    public Optional<User> getById(long id) {
        return getInitializing(userDao::findById, id);
    }

    @Override
    @PreAuthorize("@userPermissionProvider.readByUsername(${symbol_pound}username)")
    public Optional<User> getByUsername(String username) {
        return getInitializing(userDao::findByUsername, username);
    }

    @Override
    @PreAuthorize("@userPermissionProvider.readByEmail(${symbol_pound}email)")
    ...
    @Override
    @Transactional
    @PreAuthorize("@userPermissionProvider.writeById(${symbol_pound}id)")
    ...
    @Override
    @Transactional
    @PreAuthorize("@userPermissionProvider.deleteById(${symbol_pound}id)")
    ...
    @Override
    @Transactional
    @PreAuthorize("@userPermissionProvider.deleteByUsername(${symbol_pound}username)")
    ...
    @Override
    @Transactional
    @PreAuthorize("@userPermissionProvider.deleteByEmail(${symbol_pound}email)")
     ...
     * adding the {@link UserServiceImpl${symbol_pound}EMAIL_IN_USE} {@link UniqueViolationError} to the given {@code errorList}
     * if it exists.
     *
