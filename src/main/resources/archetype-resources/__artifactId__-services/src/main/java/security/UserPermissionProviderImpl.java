...
/* package */ class UserPermissionProviderImpl implements UserPermissionProvider {
     ...
     * in the {@link Authentication} retrieved by the {@link SecurityContextHolder${symbol_pound}getContext()} method.
     *
    ...
    /**
     * Checks whether the currently authenticated {@link User} is admin (i.e has {@link Role${symbol_pound}ROLE_ADMIN} role).
     *
