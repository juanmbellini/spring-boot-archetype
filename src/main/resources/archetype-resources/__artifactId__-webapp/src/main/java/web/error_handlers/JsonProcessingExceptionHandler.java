...
import ${package}.web.controller.dtos.api_errors.RepresentationErrorDto;
...
/* package */ class JsonProcessingExceptionHandler implements ExceptionHandler<JsonProcessingException> {
     ...
     * including the {@link RepresentationErrorDto${symbol_pound}REPRESENTATION_ERROR_DTO} as the entity.
