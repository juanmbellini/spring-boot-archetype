...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.web.controller.rest_endpoints;

import ${package}.error_handling.helpers.ValidationExceptionThrower;
import ${package}.models.Role;
import ${package}.models.User;
import ${package}.services.UserService;
import ${package}.web.controller.dtos.entities.StringValueDto;
import ${package}.web.controller.dtos.entities.UserDto;
import ${package}.web.support.annotations.Java8Time;
import ${package}.web.support.annotations.JerseyController;
import ${package}.web.support.annotations.PaginationParam;
import ${package}.web.support.data_transfer.DateTimeFormatters;
import ${package}.web.support.exceptions.IllegalParamValueException;
...
public class UserEndpoint implements ValidationExceptionThrower {
    ...
    @PUT
    @Path("{id : ${symbol_escape}${symbol_escape}d+}/username")
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @PUT
    @Path("{id : ${symbol_escape}${symbol_escape}d+}/email")
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @PUT
    @Path("{id : ${symbol_escape}${symbol_escape}d+}/password")
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @GET
    @Path("{id : ${symbol_escape}${symbol_escape}d+}/authorities")
    ...
    @PUT
    @Path("{id : ${symbol_escape}${symbol_escape}d+}/authorities/{role: .+}")
     ...
     * or a {@link Response.Status${symbol_pound}NOT_FOUND} {@link Response} otherwise.
     */
