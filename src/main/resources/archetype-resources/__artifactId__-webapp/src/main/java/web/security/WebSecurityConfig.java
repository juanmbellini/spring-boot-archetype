...
import ${package}.web.controller.rest_endpoints.SessionEndpoint;
import ${package}.web.controller.rest_endpoints.UserEndpoint;
import ${package}.web.security.authentication.JwtAuthenticationFilter;
import ${package}.web.security.authentication.JwtAuthenticationProvider;
import ${package}.web.security.authentication.TokenAuthenticationFailureHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean {
    ...
    @Autowired
    public WebSecurityConfig(@Value("${symbol_dollar}{spring.jersey.application-path:}") String jerseyApplicationPath,
