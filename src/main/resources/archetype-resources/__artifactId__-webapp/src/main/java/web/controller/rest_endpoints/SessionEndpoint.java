...
import ${package}.services.LoginService;
import ${package}.services.SessionService;
import ${package}.web.controller.dtos.authentication.LoginCredentialsDto;
import ${package}.web.support.annotations.Base64url;
...
public class SessionEndpoint {
    ...
    @DELETE
    @Path(LOGOUT_ROOT_ENDPOINT + "/{userId : ${symbol_escape}${symbol_escape}d+}/{jti: .+}")
