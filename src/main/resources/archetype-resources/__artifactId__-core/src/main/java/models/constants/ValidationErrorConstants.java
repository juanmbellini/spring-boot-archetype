...
import static ${package}.error_handling.errros.ValidationError.ErrorCause.ILLEGAL_VALUE;
import static ${package}.error_handling.errros.ValidationError.ErrorCause.MISSING_VALUE;
